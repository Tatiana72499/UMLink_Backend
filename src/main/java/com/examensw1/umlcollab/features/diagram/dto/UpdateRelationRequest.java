...
public record UpdateRelationRequest(
    ...
    public UpdateRelationRequest(UUID sourceClassId, UUID targetClassId, RelationType type, String label, String sourceCardinality, String targetCardinality) {
        this(sourceClassId, targetClassId, type, label, sourceCardinality, targetCardinality, null, null, null, null);
    }
    public UpdateRelationRequest(UUID sourceClassId, UUID targetClassId, RelationType type, String label, String sourceCardinality, String targetCardinality, Double bendX, Double bendY, UUID associationClassId) {
